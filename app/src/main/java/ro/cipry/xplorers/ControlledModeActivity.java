...
import ro.cipry.xplorers.widget.VerticalSeekBar;


public class ControlledModeActivity extends Activity implements SensorEventListener {

    private int currentApiVersion;
    private VerticalSeekBar seekBar_speed_layout;
    private ImageView front_arrow_layout, left_arrow_layout, right_arrow_layout,
            circle_speed_layout, battery_level_layout, back_button_layout, turbo_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_controlled_mode);
    ...
    private void initial_settings() {
        ...
        back_button_layout = (ImageView) findViewById(R.id.id_back_button);
        turbo_layout = (ImageView) findViewById(R.id.id_turbo_button);
        chronometer_layout = (Chronometer) findViewById(R.id.id_chronometer);
        seekBar_speed_layout = (VerticalSeekBar) findViewById(R.id.id_seekBar_speed);

        mSensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
        mAccel = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);


        seekBar_speed_layout.setMax(100);
        seekBar_speed_layout.setProgress(0);
        seekBar_speed_layout.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {

                if (start_enabled && connectedToDevice) {
        ...
        pwm_textView = (TextView) findViewById(R.id.id_pwm_text);
        ...
        pwm_textView.setTypeface(myTypeface);
            ...
            public void onClick(View v) {
                if (start_enabled && connectedToDevice) {
                    if (!back_button_pressed) {
                        back_button_layout.setImageResource(R.drawable.back_button_pressed);
                        ...
                        back_button_layout.setAnimation(animation);
                        ...
                        handler.postDelayed(new Runnable(){
                            @Override
                            public void run(){
                                back_button_layout.setImageResource(R.drawable.back_button_unpressed);
        ...
        turbo_layout.setOnTouchListener(new View.OnTouchListener() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_controlled_mode, menu);
        return true;
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (false) Log.i("INFO Senzor","Senzor acc_x: " + x + " | acc_y: " + y);

        if (/*!stopWorker &&*/ connectedToDevice && start_enabled) {
